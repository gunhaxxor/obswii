...
static const float MAGNETIC_DECLINATION = 0.0f; // Declination at Danville, California is 13 degrees 48 minutes and 47 seconds on 2014-04-04
...
static void EM7180_set_integer_param(uint8_t param, uint32_t param_val)
{
  ...
  while (true)
  {
    if (em7180.getParamAcknowledge() == param)
      break;
  }
...
static void readParams(uint8_t paramId, uint8_t param[4])
{
  ...
  while (true)
  {
    if (em7180.getParamAcknowledge() == paramId)
      break;
  }
